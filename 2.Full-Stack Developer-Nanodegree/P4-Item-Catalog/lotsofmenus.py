...
description = "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Delectus similique vitae minima perspiciatis, sint minus at voluptas fuga. Nam enim, consequuntur id a culpa ab reprehenderit. Sequi, inventore accusamus quia. Repellendus"
image = "http://via.placeholder.com/750x750"

# Menu for UrbanBurger
restaurant1 = Restaurant(name="Urban Burger", description=description, image=image)
...
restaurant2 = Restaurant(name="Super Stir Fry", description=description, image=image)
...
restaurant1 = Restaurant(name="Panda Garden", description=description, image=image)
...
restaurant1 = Restaurant(name="Thyme for That Vegetarian Cuisine ", description=description, image=image)
...
restaurant1 = Restaurant(name="Tony\'s Bistro ", description=description, image=image)
...
# Menu for Andala's
restaurant1 = Restaurant(name="Andala\'s", description=description, image=image)
...
restaurant1 = Restaurant(name="Auntie Ann\'s Diner' ", description=description, image=image)
...
restaurant1 = Restaurant(name="Cocina Y Amor ", description=description, image=image)
...
restaurant1 = Restaurant(name="State Bird Provisions", description=description, image=image)
SESSION.add(restaurant1)
SESSION.commit()
